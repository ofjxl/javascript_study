...
//삼항 조건 ver2 userpw
let number = userpw == 1234 ? '로그인 성공' : '로그인 실패'
console.log(number)
//-----------------논리연산+
//&&(and) 모두 참일 때 참  
//||(or) 하나라도 참이면 참 
...
if(조건식1){
    ...
    조건삭1, 조건식2 모두 거짓이고 조건식3 참일 때 실행결과
}else{
...
//논리연산을 이요한 간편한 처리 방법
if(move=='왼쪽' || move=='오른쪽' || move=='왼쪽' || move=='아래쪽'){
...
//69~60 D
//59 이하면 F
//0~100사이가 아닌 잘못된 숫자 입력 시 '오류 발생'
//A~F 결과기준 출력 예시 => "당신의 점수는 o 학점입니다"
let score = 100
let total = ""
...
console.log(month, btn, birth_result)
