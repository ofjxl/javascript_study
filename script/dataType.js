...
console.log(typeof (a+b)) //숫자(number)+문자(string)=문자
...
console.log(`typeof1_replace 값은 ${type1_replace}, 데이터타입은 ${typeof type1_replace}`)
let type2 = "20"
...
console.log(yoil);console.log(yoil[4]); //금
